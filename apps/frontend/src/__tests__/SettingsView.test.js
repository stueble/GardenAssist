...
function renderSettings(garden = MOCK_GARDEN) {
    return render(_jsx(MemoryRouter, { children: _jsx(I18nextProvider, { i18n: i18n, children: _jsx(SettingsView, { garden: garden, loading: garden === null, invalidateGarden: vi.fn() }) }) }));
}
describe("SettingsView — API integration", () => {
    ...
    it("calls updateSettings on save (AC #2)", async () => {
        ...
        const called = apiClient.updateSettings.mock.calls[0][0];
